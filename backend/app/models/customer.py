...
class Customer(Base):
    ...
    business_registration_number: Mapped[str | None] = mapped_column(String(32), nullable=True)
    representative_name: Mapped[str | None] = mapped_column(String(64), nullable=True)
    ...
    arrears: Mapped[float | None] = mapped_column(Numeric(14, 2), nullable=True)  # 미수금액
